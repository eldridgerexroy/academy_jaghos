        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/webinars*', false)) and !request()->is(getAdminPanelUrl('/webinars/comments*', false))) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    @endcan
                    <li class="{{ (request()->is(getAdminPanelUrl('/webinars/request_recording', false))) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/webinars/request_recording">{{ trans('admin/main.request_recording') }}</a>
                    </li>
                    <li class="{{ (request()->is(getAdminPanelUrl('/webinars/webinar_recording', false))) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/webinars/webinar_recording">{{ trans('admin/main.webinar_recording') }}</a>
                    </li>
                </ul>
            </li>
            @endcan()
            ...
            <li class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/certificates*', false))) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ (request()->is(getAdminPanelUrl('/certificates/templates', false))) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/certificates/templates">{{ trans('admin/main.certificates_templates') }}</a>
                    </li>
                    @endcan

                    @can('admin_certificate_template_create')
                    <li class="{{ (request()->is(getAdminPanelUrl('/certificates/templates/new', false))) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/certificates/templates/new">{{ trans('admin/main.new_template') }}</a>
                    </li>
                    @endcan
                </ul>
            </li>
            ...
            <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/universities', false)) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    <li class="{{ (request()->is(getAdminPanelUrl('/universities', false))) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/universities">{{ trans('admin/main.admin_universities_list') }}</a>
                    </li>
            ...
            <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('syllabus', false)) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ (request()->is(getAdminPanelUrl('syllabus/create', false))) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/syllabus/create">{{ trans('admin/main.admin_syllabus_create') }}</a>
                    </li>
                </ul>
            </li>
            {{-- END SYLLABUS CUSTOM --}}
