        ...
        <div class="row">
            ...
            <div class="col-6 d-flex align-items-center justify-content-center">
                <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <strong class="font-30 text-dark-blue font-weight-bold mt-5">{{ handlePrice($sumAffiliateBonus) }}</strong>
                ...
                <div class="table-responsive">
                    <table class="table text-center custom-table">
                        ...
                        <tbody>
                            ...
                            @foreach($affiliateBonus as $bonus)
                            <tr>
                                <td class="text-left">
                                    <div class="user-inline-avatar d-flex align-items-center">
                                        ...
                                        <div class=" ml-5">
                                            <span class="d-block font-weight-500">{{ maskName($affiliate->referredUser->full_name) }}</span>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>{{ handlePrice($bonus->amount) }}</td>

                                <td>{{ dateTimeFormat($bonus->created_at, 'Y M j | H:i') }}</td>
