        ...
        <div class="d-flex align-items-center justify-content-between w-100">
            ...
            <a class="navbar-brand navbar-order d-flex align-items-center justify-content-center mr-0 <?php echo e((empty($navBtnUrl) and empty($navBtnText)) ? 'ml-auto' : ''); ?>" href="/">
                <?php if(!empty($generalSettings['logo'])): ?>
                    <img src="<?php echo e($generalSettings['logo']); ?>" style="height:auto !important;" class="img-cover" alt="site logo">
                <?php endif; ?>
            </a>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/sophis/academy.sophistec.dev/resources/views/web/default/includes/navbar.blade.php ENDPATH**/ ?>