    ...
    <?php if(getOthersPersonalizationSettings('platform_phone_and_email_position') == 'footer'): ?>
        <div class="footer-copyright-card"> 
            <div class="container d-flex align-items-center justify-content-between py-15">
                <div class="font-14 text-white"><?php echo e(trans('update.platform_copyright_hint')); ?><a style="color: white;" href='https://sophistec.dev/en'  target='_blank'>Sophistec</a>.</div>
...
<?php /**PATH /home/sophis/academy.sophistec.dev/resources/views/web/default/includes/footer.blade.php ENDPATH**/ ?>