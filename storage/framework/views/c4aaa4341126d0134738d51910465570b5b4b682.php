        ...
        <div class="row">
            ...
            <div class="col-6 d-flex align-items-center justify-content-center">
                <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <strong class="font-30 text-dark-blue font-weight-bold mt-5"><?php echo e(handlePrice($sumAffiliateBonus)); ?></strong>
                ...
                <div class="table-responsive">
                    <table class="table text-center custom-table">
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $affiliateBonus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bonus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="text-left">
                                    <div class="user-inline-avatar d-flex align-items-center">
                                        ...
                                        <div class=" ml-5">
                                            <span class="d-block font-weight-500"><?php echo e(maskName($affiliate->referredUser->full_name)); ?></span>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td><?php echo e(handlePrice($bonus->amount)); ?></td>

                                <td><?php echo e(dateTimeFormat($bonus->created_at, 'Y M j | H:i')); ?></td>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sophis/academy.sophistec.dev/resources/views/web/default/panel/marketing/affiliates.blade.php ENDPATH**/ ?>