        ...
        <figcaption class="webinar-card-body">
            ...
            <?php if(!empty($isRewardCourses) and !empty($webinar->points)): ?>
                ...
                <?php elseif(!empty($webinar->price) and $webinar->price > 0): ?>
                    <?php if($webinar->bestTicket() < $webinar->price): ?>
                        <span class="real"><?php echo e(handlePrice($webinar->bestTicket(), true, true, false, null, false)); ?></span>
                        <span class="off ml-10"><?php echo e(handlePrice($webinar->price, true, true, false, null, false)); ?></span>
                    <?php else: ?>
                        <span class="real"><?php echo e(handlePrice($webinar->price, true, true, false, null, false)); ?></span>
                    <?php endif; ?>
                <?php else: ?>
...
<?php /**PATH /home/sophis/academy.sophistec.dev/resources/views/web/default/includes/webinar/grid-card.blade.php ENDPATH**/ ?>