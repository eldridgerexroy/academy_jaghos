...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(!empty($heroSectionData)): ?>
        ...
        <section style="padding-bottom:0px" class="slider-container  <?php echo e(($heroSection == "2") ? 'slider-hero-section2' : ''); ?>" <?php if(empty($heroSectionData['is_video_background'])): ?> style="background-image: url('<?php echo e($heroSectionData['hero_background']); ?>')" <?php endif; ?>>
        ...
        <div class="row align-items-center">
            <div class="col-12 col-lg-6 mt-20 mt-lg-0">
                <div class="position-relative">
                    <img src="<?php echo e($forumSection['image']); ?>" class="university-list-section-hero" alt="<?php echo e($forumSection['title']); ?>">
    ...
    <?php $__currentLoopData = $homeSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $homeSection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if($homeSection->name == \App\Models\HomeSection::$latest_classes and !empty($latestWebinars) and !$latestWebinars->isEmpty()): ?>
            <section class="home-sections container">
                <div class="d-flex justify-content-between">
                    <div>
                        <h2 class="section-title"><?php echo e(trans('home.universities')); ?></h2>
                        <p class="section-hint"><?php echo e(trans('home.universities_hint')); ?></p>
                    </div>
                </div>
                                ...
                                <div class="shadow-effect">
                                    <div class="instructors-card d-flex flex-column align-items-center justify-content-center">
                                        <div class="instructors-card-avatar">
                                            <img src="<?php echo e(asset('store/' . $university['picture'])); ?>" alt="<?php echo e($university['name']); ?>" class="img-cover">
                                        </div>
                                        <div class="instructors-card-info mt-10 text-center">
                                            <a href="<?php echo e($university['link']); ?>" target="_blank">
                                                <h3 class="font-16 font-weight-bold text-dark-blue"><?php echo e($university['name']); ?></h3>
                                            </a>
                                            <p class="font-14 text-gray mt-5"><?php echo e($university['city']); ?>, <?php echo e($university['country']); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="home-sections container">
                <div class="d-flex justify-content-between">
                    <div>
                        <h2 class="section-title"><?php echo e(trans('home.supported_by')); ?></h2>
                        <p class="section-hint"><?php echo e(trans('home.supported_by_hint')); ?></p>
                    </div>
                </div>
                ...
                <div class="position-relative mt-20 ltr">
                    <div class="owl-carousel customers-testimonials instructors-swiper-container">
                        ...
                        <?php $__currentLoopData = $supported_by; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supported): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="item">
                                <div class="shadow-effect">
                                    <div class="instructors-card d-flex flex-column align-items-center justify-content-center">
                                        <div class="instructors-card-avatar">
                                            <img src="<?php echo e(asset('store/1/academy/supported/' . $supported['image'])); ?>" alt="<?php echo e($supported['name']); ?>" class="img-cover">
                                        </div>
                                        <div class="instructors-card-info mt-10 text-center">
                                            <a href="<?php echo e($supported['link']); ?>" target="_blank">
                                                <h3 class="font-16 font-weight-bold text-dark-blue"><?php echo e($supported['name']); ?></h3>
                                            </a>
                                            <p class="font-14 text-gray mt-5"><?php echo e($supported['type']); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sophis/academy.sophistec.dev/resources/views/web/default/pages/home.blade.php ENDPATH**/ ?>