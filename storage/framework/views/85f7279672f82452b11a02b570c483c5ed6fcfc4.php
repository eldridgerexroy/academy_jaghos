    ...
    <div class="card">
        <div class="card-header">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_enrollment_add_student_to_items')): ?>
                <button type="button" id="addStudentToCourse" data-search-option="all" class="btn btn-primary mr-2"><?php echo e(trans('update.add_student_to_course')); ?></button>
            <?php endif; ?>
            <div class="h-10"></div>
        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sophis/academy.sophistec.dev/resources/views/admin/webinars/students.blade.php ENDPATH**/ ?>