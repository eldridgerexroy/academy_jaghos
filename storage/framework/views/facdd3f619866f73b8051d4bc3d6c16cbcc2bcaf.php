<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_webinars')): ?>
                <li class="nav-item dropdown <?php echo e((request()->is(getAdminPanelUrl('/webinars*', false)) and !request()->is(getAdminPanelUrl('/webinars/comments*', false))) ? 'active' : ''); ?>">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php endif; ?>
                        <li class="<?php echo e((request()->is(getAdminPanelUrl('/webinars/request_recording', false))) ? 'active' : ''); ?>">
                            <a class="nav-link" href="<?php echo e(getAdminPanelUrl()); ?>/webinars/request_recording"><?php echo e(trans('admin/main.request_recording')); ?></a>
                        </li>
                        <li class="<?php echo e((request()->is(getAdminPanelUrl('/webinars/webinar_recording', false))) ? 'active' : ''); ?>">
                            <a class="nav-link" href="<?php echo e(getAdminPanelUrl()); ?>/webinars/webinar_recording"><?php echo e(trans('admin/main.webinar_recording')); ?></a>
                        </li>
                    </ul>
                </li>
            <?php endif; ?>
            ...
            <li class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/universities', false)) ? 'active' : ''); ?>">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    <i class="fas fa-users"></i>
                    <span><?php echo e(trans('admin/main.universities')); ?></span>
                </a>

                <ul class="dropdown-menu">
                    <li class="<?php echo e((request()->is(getAdminPanelUrl('/universities', false))) ? 'active' : ''); ?>">
                        <a class="nav-link" href="<?php echo e(getAdminPanelUrl()); ?>/universities"><?php echo e(trans('admin/main.admin_universities_list')); ?></a>
                    </li>
                    <li class="<?php echo e((request()->is(getAdminPanelUrl('/universities/create', false))) ? 'active' : ''); ?>">
                        <a class="nav-link" href="<?php echo e(getAdminPanelUrl()); ?>/universities/create"><?php echo e(trans('admin/main.admin_universities_create')); ?></a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('majors', false)) ? 'active' : ''); ?>">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    <i class="fas fa-users"></i>
                    <span><?php echo e(trans('admin/main.majors')); ?></span>
                </a>

                <ul class="dropdown-menu">
                    <li class="<?php echo e((request()->is(getAdminPanelUrl('majors', false))) ? 'active' : ''); ?>">
                        <a class="nav-link" href="<?php echo e(getAdminPanelUrl()); ?>/majors"><?php echo e(trans('admin/main.admin_major_list')); ?></a>
                    </li>
                    <li class="<?php echo e((request()->is(getAdminPanelUrl('majors/create', false))) ? 'active' : ''); ?>">
                        <a class="nav-link" href="<?php echo e(getAdminPanelUrl()); ?>/majors/create"><?php echo e(trans('admin/main.admin_major_create')); ?></a>
                    </li>
                </ul>
            </li>
...
<?php /**PATH /home/sophis/academy.sophistec.dev/resources/views/admin/includes/sidebar.blade.php ENDPATH**/ ?>