...
class WebinarRecordingRequestController extends Controller
{
    ...
    {
        $webinar_recording = WebinarRecordingRequest::where('user_id',Auth::id())->orderBy('created_at', 'asc')->paginate(10);
        ...
        return view(getTemplate() . '.panel.webinar.recording_request.lists', $data);
    }
    ...
    public function create()
    {
        ...
        $data = [
            ...
            'webinar_recording' => $webinar_recording,
            'purchased_courses' => $user->getAllPurchasedWebinarsIds()
        ];

        return view(getTemplate() . '.panel.webinar.recording_request.create', $data);
    }
